...
export const appTitle = "text-5xl md:text-[5rem] leading-normal font-extrabold text-gray-700"
export const purpleText = "text-purple-400"
export const body = 'text-2xl text-gray-700'
export const grid = 'grid gap-3 pt-3 mt-3 text-center md:grid-cols-2 lg:w-2/3 xl:grid-cols-4'
